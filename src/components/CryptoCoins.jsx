    ...
    <>
      <div className="container">
        ...
        <div className="search-crypto">
          <Input placeholder="Search Cryptocurrency" onChange={(e) => setSearchCoin(e.target.value)} className="input" />
        </div>
        )}
            ...
            <Col xs={12} sm={12} lg={6} className="crypto-card" key={currency.id}>
              <Link to={`/crypto/${currency.id}`} className="link">
                <Card
                  ...
                  extra={<img className="crypto-img" src={currency.iconUrl} alt="coin logo" />}
                  hoverable
                >
                  <p>
                    Price:
